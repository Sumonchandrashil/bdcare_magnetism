                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(degree_details, index) in form.degree_details">
                                    ...
                                    <td>
                                        <input type="text" v-model="degree_details.institute" class="form-control form-control-sm m-input" placeholder="Name of the institute">
                                        <div class="requiredField" v-if="errors['degree_details.'+index+'.institute']">{{ errors['degree_details.'+index+'.institute'][0] }}</div>
                                    </td>
                                    <td>
                                        <a @click="removeItemDegree(index,degree_details.degree_id)" class="btn btn-outline-danger m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air" data-offset="-20px -20px" data-toggle="m-tooltip" data-placement="top" title="Delete"><i class="la la-trash-o"></i></a>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <a @click="removeItem(index,details.speciality_id)" class="btn btn-outline-danger m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air" data-offset="-20px -20px" data-toggle="m-tooltip" data-placement="top" title="Delete"><i class="la la-trash-o"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right"></td>
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(hospital_details, index) in form.hospital_details">
                                    ...
                                    <td>
                                        <input type="text" id="f_time" v-model="hospital_details.f_time" v-bind:data-index="index" class="form-control form-control-sm m-input" placeholder="">
                                        <div class="requiredField" v-if="errors['hospital_details.'+index+'.f_time']">{{ errors['hospital_details.'+index+'.f_time'][0] }}</div>
                                    </td>
                                    <td>
                                        <input type="text" id="s_time" v-model="hospital_details.s_time" v-bind:data-index="index" class="form-control form-control-sm m-input" placeholder="">
                                    ...
                                    <td>
                                        <a @click="removeItemHospital(index,hospital_details.hospital_id)" class="btn btn-outline-danger m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air" data-offset="-20px -20px" data-toggle="m-tooltip" data-placement="top" title="Delete"><i class="la la-trash-o"></i></a>
                                    </td>
                                </tr>
                                <tr>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'appointment_booked/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id){
                ...
                axios.put(base_url+'appointment_booked/'+id, this.form).then( (response) => {
        ...
        mounted(){
            ...
            /*$(document).on("focus", "#f_time", function () {
                $(this).timepicker({
                    ...
                    _this.form.hospital_details[dataIndex].f_time = timeField;
                })
            });
            ...
            $(document).on("focus", "#s_time", function () {
                $(this).timepicker({
                    ...
                    dataIndex = $(e.currentTarget).attr('data-index');
                    _this.form.hospital_details[dataIndex].s_time = timeField;
                })
            });*/
            ...
            $('#editComponent').on('change', '.select-degree', function (e) {
                var selectedItem = $(this),
                    curerntVal = !!selectedItem.val(),
                    dataIndex = $(e.currentTarget).attr('data-index');
            ...
            $('#editComponent').on('change', '.select-hospital', function (e) {
                var selectedItem = $(this),
                    curerntVal = !!selectedItem.val(),
                    dataIndex = $(e.currentTarget).attr('data-index');
            ...
            $('#editComponent').on('change', '.select-day', function (e) {
                var selectedItem = $(this),
                    curerntVal = !!selectedItem.val(),
                    dataIndex = $(e.currentTarget).attr('data-index');
