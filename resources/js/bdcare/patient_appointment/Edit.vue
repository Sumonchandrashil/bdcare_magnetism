                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(hospital_details, index) in form.hospital_details">
                                    ...
                                    <td>
                                        <input type="text" v-model="hospital_details.f_time" class="form-control form-control-sm m-input" placeholder="">
                                        <div class="requiredField" v-if="errors['hospital_details.'+index+'.f_time']">{{ errors['hospital_details.'+index+'.f_time'][0] }}</div>
                                    </td>
                                    <td>
                                        <input type="text" v-model="hospital_details.s_time" class="form-control form-control-sm m-input" placeholder="">
        ...
        methods:{
            ...
            duplicateCheckDay(){
                ...
                if (no_index > 1) {
                    for (let i = 0; i < no_index; i++) {
                        for (let j = i+1; j < no_index; j++) {
                            if(details[i].day == details[j].day) {
                                alert("Duplicate. Day Already Selected");
                                details[j].day = '';
                                var Select2 = {
                                    init: function () {
                                        $(".select2").select2({
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'appointment_booking/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id){
                ...
                axios.put(base_url+'appointment_booking/'+id, this.form).then( (response) => {
