                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(surgery_details, index) in form.surgery_details">
                                    ...
                                    <td>
                                        <a @click="removeItemSurgery(index)" class="btn btn-outline-danger m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air" data-offset="-20px -20px" data-toggle="m-tooltip" data-placement="top" title="Delete"><i class="la la-trash-o"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right"></td>
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(allergy_details, index) in form.allergy_details">
                                    ...
                                    <td>
                                        <a @click="removeItemAllergy(index)" class="btn btn-outline-danger m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air" data-offset="-20px -20px" data-toggle="m-tooltip" data-placement="top" title="Delete"><i class="la la-trash-o"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right"></td>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            store:function(){
                var _this = this;
                axios.post(base_url+'patient_profile', this.form).then( (response) => {
        ...
        mounted(){
            var _this = this;
            $('#addComponent').on('change', '.select-disease', function (e) {
