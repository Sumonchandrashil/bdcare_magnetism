        ...
        data: function(){
            return {
                ...
                fields: {
                    ...
                    area_name: { label: 'Area Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                    'cities.city_name': { label: 'City Name',template:'{{ row.city_name}}', sortable: true, searchable: true  },
                ...
                deleteData(id,tr){
                    ...
                    swal({
                        ...
                        function(){
                            ...
                            axios.delete(base_url+'setup_area/'+id).then((response) => {
