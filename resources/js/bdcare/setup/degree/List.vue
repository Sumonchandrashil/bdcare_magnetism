...
<script>
    ...
    export default {
        ...
        data: function(){
            return {
                //VdtnetTable Options
                tableId: 'setup_degree',
                options: {
                    ajax: {
                        url: base_url+"setup_degree",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    degree_name: { label: 'Area Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                ...
                deleteData(id,tr){
                    ...
                    swal({
                        ...
                        function(){
                            ...
                            axios.delete(base_url+'setup_degree/'+id).then((response) => {
