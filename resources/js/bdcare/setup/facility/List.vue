...
<script>
    ...
    export default {
        ...
        data: function(){
            return {
                //VdtnetTable Options
                tableId: 'setup_facilities',
                options: {
                    ajax: {
                        url: base_url+"setup_facilities",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    facility_name: { label: 'Facility Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                ...
                deleteData(id,tr){
                    ...
                    swal({
                        ...
                        function(){
                            ...
                            axios.delete(base_url+'setup_facilities/'+id).then((response) => {
