...
<script>
    ...
    export default {
        ...
        data: function(){
            return {
                //VdtnetTable Options
                tableId: 'setup_medicine',
                options: {
                    ajax: {
                        url: base_url+"setup_medicine",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    medicine_name: { label: 'Medicine Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                    description: { label: 'Remarks', sortable: false, searchable: false },
        ...
        methods: {
                /*index(pageNo,perPage){
                    ...
                    axios.get(base_url+"setup_medicine/?page="+pageNo+"&perPage="+perPage).then((response) => {
                ...
                deleteData(id,tr){
                    ...
                    swal({
                        ...
                        function(){
                            ...
                            axios.delete(base_url+'setup_medicine/'+id).then((response) => {
                                //_this.index(1);
