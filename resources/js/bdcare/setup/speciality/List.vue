...
<script>
    ...
    export default {
        ...
        data: function(){
            return {
                //VdtnetTable Options
                tableId: 'setup_speciality',
                options: {
                    ajax: {
                        url: base_url+"setup_speciality",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    speciality_name: { label: 'Speciality Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
        ...
        methods: {
                /*index(pageNo,perPage){
                    ...
                    axios.get(base_url+"setup_speciality/?page="+pageNo+"&perPage="+perPage).then((response) => {
                ...
                deleteData(id,tr){
                    ...
                    swal({
                        ...
                        function(){
                            ...
                            axios.delete(base_url+'setup_speciality/'+id).then((response) => {
