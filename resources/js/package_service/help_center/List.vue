        ...
        data: function(){
            return {
                ...
                fields: {
                    ...
                    title: { label: 'Title', sortable: true, searchable: true, defaultOrder: 'asc'  },
                    entry_date: { label: 'Date', sortable: true, searchable: true },

                    terms_condition: { label: 'Terms and Condition', sortable: false, searchable: false  },
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'help-center/'+id).then((response) => {
                           // _this.index(1);
