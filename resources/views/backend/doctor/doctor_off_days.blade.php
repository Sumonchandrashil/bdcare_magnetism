...
<div class="profileContent" style="padding: 50px">
    ...
    <button class="btn btn-info " data-toggle="modal" data-target="#exampleModal">ADD Doctor Off Day</button>
    ...
    <div class='table-responsive'>
        <div style="overflow-x:auto;">
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                <?php $i=1;?>
                @foreach($doc_off_day_data as $doc_data)
                    <tr>
                        <td><?=$i++?></td>
                        <td>{{dateConvertDBtoForm($doc_data->doctor_off_day)}}</td>
                        <td>
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"
                                    onclick="get_data(<?=$doc_data->id;?>);">Edit
                            </button>
                            <a onclick="return confirm('Are you sure you want to delete this Article?');"
                               class="btn btn-danger"
                               href="{{url('delete-doctor-off-days')."/".$doc_data->id}}">Delete</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
