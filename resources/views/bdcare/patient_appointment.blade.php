                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="javascript:void(0)" class="m-nav__link">
                                <span class="m-nav__link-text">Appointment Setup</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <list
                                ...
                                :degree_lists="{{json_encode($DegreeLists)}}"
                                :speciality_lists="{{json_encode($SpecialityLists)}}"
                                :hospital_lists="{{json_encode($HospitalLists)}}"
                                :day_lists="{{json_encode($DayLists)}}"
                                :city_lists="{{json_encode($CityLists)}}"
                                :area_lists="{{json_encode($AreaLists)}}"
                        ></list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/bdcare/patient_appointment.js') !!}"></script>
@endpush
