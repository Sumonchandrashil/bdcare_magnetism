@extends('master')
@section('title','Manage Patient Medication')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="javascript:void(0)" class="m-nav__link">
                                <span class="m-nav__link-text">Area</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                    <span>
                                        ...
                                        <span>Add Patient Medication</span>
                                    </span>
                                </a>
                            </div>
                        </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/bdcare/patient_medication.js') !!}"></script>
@endpush
