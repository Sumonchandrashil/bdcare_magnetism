...
<script>
    ...
    function check_field_hos(T1,T2) {
        ...
        var T_pos = T1;//T.split('-')[0];

        var url_pos = T2;//T.substring(T.indexOf("-") + 1);
                ...
                <div class="searchArea">
                    ...
                    <div class="areaBox">
                        ...
                        <ul>
                            ...
                            <li style="margin-top: -21px;margin-left: -4px;">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 no-padding">
                            ...
                            <div class="appointmentPanel appointmentPanel<?=$i;?>">
                                ...
                                <div class="appointmentData">
                                    ...
                                    <p style="text-align: center;font-weight: bold">Select a date & time to book an appointment</p>
								    ...
								    <span>
                                            ...
                                            <ul class="list-inline">
								   			...
								   			<i class="far fa-calendar"></i><input style="width: 50%" type="text" autocomplete="off" class="form-control date-picker" id="datepicker<?=$T;?>" name="datepicker" placeholder="Select Appointment Date">

                                                <div id="datepickerspan<?=$T;?>" style="color: red"></div>
                                                <input type="hidden" value="<?=$row_data->hospital_id;?>" name="hospital" id="hospital<?=$T;?>">
                                                <input type="hidden" value="<?=$row_data->doctor_id;?>" name="doctor" id="doctor<?=$T;?>">
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 no-padding">
                                    ...
                                    <div class="callNowTwoPanel callNowPanelClinic<?=$i;?>" style="height: auto">
                                        ...
                                        @foreach($clinic_datas as $clinic_data)
                                            ...
                                            if($clinic_data->day == 'Sat' || $clinic_data->day == 'SAT')
                                            {
                                                $dayy = 6;
                                            }
                                            elseif($clinic_data->day == 'Sun' || $clinic_data->day == 'SUN')
                                            {
                                                $dayy = 0;
                                            }
                                            elseif($clinic_data->day == 'Mon' || $clinic_data->day == 'MON')
                                            {
                                                $dayy = 1;
                                            }
                                            elseif($clinic_data->day == 'Tue' || $clinic_data->day == 'TUE')
                                            {
                                                $dayy = 2;
                                            }
                                            elseif($clinic_data->day == 'Wed' || $clinic_data->day == 'WED')
                                            {
                                                $dayy = 3;
                                            }
                                            elseif($clinic_data->day == 'Thu' || $clinic_data->day == 'THU')
                                            {
                                                $dayy = 4;
                                            }
                                            elseif($clinic_data->day == 'Fri' || $clinic_data->day == 'FRI')
                                            {
                                                $dayy = 5;
                                            }
                                            ?>
