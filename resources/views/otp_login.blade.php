            ...
            <div class="col-lg-8 col-md-8 col-xs-12 offset-md-2">
                <div class="loginPanelRight">
                    <div class="loginForm" style="height: auto">
                        ...
                        @endif
                        <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your Mobile No" name="email"
                               <?php
                        ...
                        <div class="form-group">
                            <input required type="text" class="form-control" id="exampleInputMobile1" placeholder="Enter your OTP Here" name="password">
                        </div>
