@extends('master')
@section('title','Manage Book Packages')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="javascript:void(0)" class="m-nav__link">
                                <span class="m-nav__link-text">Book Packages</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <book-packages-list></book-packages-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
    <script type="text/javascript" src="{!! asset('js/book_packages/book-packages.js') !!}"></script>
@endpush
