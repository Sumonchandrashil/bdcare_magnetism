@extends('master')
@section('title','Manage Help Center')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="javascript:void(0)" class="m-nav__link">
                                <span class="m-nav__link-text">Pacakage and Service</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/help-center/help-center.js') !!}"></script>
@endpush
